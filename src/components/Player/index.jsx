// Переосмысление всей логики (Готово - текущая основная версия)
// Версия без redux
...
// Переосмысление всей логики (Тоже рабочая версия, но тут естественное окончание трека и окончание по времени обрабатываются отдельно)
// Версия без redux
// import React, { Fragment, useState, createRef, useEffect } from 'react';
// import classNames from 'classnames';
...
// // TODO: А по хорошему надо сделать проверки на существование видео и аудиофайла
// // TODO: ВООБЩЕ все порефакторить, чтобы небыло дублирования и более понятно, такие моменты как stop play pause reset и тд
// // Просто всё попереосмыслять, так как стало очень запутанно
...
// 	// TODO: Исправить баг с тем, что когда трек заканчивается, нужно его запускать .play
// 	const onEnd = () => {
// 		resetTime();
// 		setIsEnded(false);
...
// 	// Эта штука никак не зависит от isEnded - она выполнится если закончится сам трек
// 	const onEndTrack = () => {
// 		console.log('ENDED');
// 		setIsPlaying(false)
// 		resetTime();
// 		if (isLooped) playSound();
// 	}
...
// 	// Если вынести сюда кнопки выбора времени, то можно и для них хот кеи сделать
// 	const handleHotKeys = (e) => {
// 		e.preventDefault();
// 		console.log(e.keyCode)
// 		switch (e.keyCode) {
...
// 	useEffect(() => {
// 		audioRef.current.addEventListener('ended', onEndTrack);
// 		return () => audioRef.current.removeEventListener('ended', onEndTrack);
// 	})
...
// 			<div className="App__times">
// 				<button className={ classNames('Button', { 'Button--active': fakeDuration === 15 }) } name="15" title="2 минуты" onClick={setDuration}>2 минуты</button>
...
// 					</svg> }
// 				</button>
// 				<a href="mailto:alfie9@mail.ru" title="Связаться со мной" className="Button">
// 					<svg viewBox="0 0 11 19" xmlns="http://www.w3.org/2000/svg">
// 					<path d="M5.28 12.768C5.904 12.768 6.096 12.528 6.216 11.88C6.696 9.72 10.56 9.36 10.56 5.16C10.56 2.856 8.712 0.935999 5.52 0.935999C3.744 0.935999 2.28 1.68 1.32 2.712C1.152 2.904 0.984 3.168 0.984 3.456C0.984 3.624 1.032 3.792 1.2 3.96L1.752 4.512C1.968 4.728 2.184 4.824 2.424 4.824C2.616 4.824 2.808 4.752 3 4.584C3.624 3.984 4.368 3.696 5.352 3.696C6.648 3.696 7.608 4.632 7.608 5.76C7.608 8.688 3.6 8.616 3.6 11.928C3.6 12.456 3.936 12.768 4.344 12.768H5.28ZM3.168 16.2C3.168 17.184 3.888 18.12 5.064 18.12C6.12 18.12 6.84 17.184 6.84 16.2C6.84 15.36 6.12 14.424 5.064 14.424C3.888 14.424 3.168 15.36 3.168 16.2Z" />
// 				</svg>
// 				</a>
